...
.var LCD_DATA = $00            // one byte for stashing LCD display char
.var NUM1 = $01                    // two bytes at $01 and $02
.var NUM2 = $03                    // two bytes at $03 and $04
.var REM = $05                     // two bytes at $05 and $06
.var NUM_TO_DEC = $07        // two bytes at $07 and $08
.var STASH = $09                 // two bytes at $09 and $0a
.var FIB = $0b                     // two bytes at $0b and $0c
.var NXT_FIB = $0d             // two bytes at $0d and $0e

.var DEC_REVERSE = $f0     // up to five bytes (f0-f4)
